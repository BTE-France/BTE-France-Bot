...
class Warps(commands.Cog):
    ...
    async def warps(self, ctx):
        ...
        for name, desc in warps.items():
            ...
            embed.add_field(name=desc[0], value=desc[1], inline=False)
